...
export default function ProjectDashboardPage() {
  ...
  const getGovStatusColor = (isCompliant: boolean) => {
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          {project.managementType === 'FS_MANAGED' && (
            <div style={{ textAlign: 'right', paddingRight: '24px', borderRight: '1px solid #e2e8f0' }}>
              <span style={{ color: '#64748b', fontSize: '12px', textTransform: 'uppercase', fontWeight: 600 }}>
                Sprint Velocity
              </span>
              <div style={{ fontSize: '28px', fontWeight: 800, color: '#10b981', marginTop: '2px' }}>
                {project.sprintVelocity || 0} pts
              </div>
            </div>
          )}
